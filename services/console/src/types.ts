...
export type ProjectApiKeyParams = Pick<
  ProjectApiKey,
  "name" | "description" | "scope" | "role"
>;
...
export type ListCreateParams = Pick<
  List,
  "name" | "rule" | "type" | "tags" | "is_visible"
>;
...
export type CampaignLaunchParams = Pick<
  Campaign,
  "send_at" | "send_in_user_timezone" | "state"
...
export type SubscriptionCreateParams = Pick<
  Subscription,
  "name" | "channel" | "is_public"
>;
export type SubscriptionUpdateParams = Pick<
