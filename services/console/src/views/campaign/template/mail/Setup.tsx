        ...
        <div className="px-6 py-4">
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="flex items-center gap-1 text-gray-600 flex-shrink-0">
              ...
              <button className="p-2 hover:bg-gray-100 rounded-full" title="Report spam">
                <ReportIcon />
              </button>
          ...
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white font-medium flex-shrink-0">
              {displayFromName ? displayFromName.charAt(0).toUpperCase() : displayFromEmail ? displayFromEmail.charAt(0).toUpperCase() : '?'}
            </div>

            <div className="flex-1 min-w-0">
              <div className="flex items-baseline gap-2 mb-1">
                <span className="font-medium text-gray-900 text-sm">
                  {displayFromName || displayFromEmail || <span className="text-gray-400 italic">Unknown sender</span>}
                </span>
