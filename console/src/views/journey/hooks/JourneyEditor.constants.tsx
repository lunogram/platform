...
export const stepCategoryColors: Record<string, string> = {
    entrance: "bg-emerald-100 text-emerald-600 dark:bg-emerald-950 dark:text-emerald-400",
    action: "bg-blue-100 text-blue-600 dark:bg-blue-950 dark:text-blue-400",
    flow: "bg-orange-100 text-orange-600 dark:bg-orange-950 dark:text-orange-400",
...
export const stepCategoryBorderColors: Record<string, string> = {
    entrance: "border-emerald-300 dark:border-emerald-800",
    action: "border-blue-300 dark:border-blue-800",
    flow: "border-orange-300 dark:border-orange-800",
...
export const stepCategoryMinimap: Record<string, string> = {
    entrance: "fill-emerald-200 dark:fill-emerald-900",
    action: "fill-blue-200 dark:fill-blue-900",
    flow: "fill-orange-200 dark:fill-orange-900",
