...
const templateVariableGroups: TemplateVariableGroup[] = [
  {
    ...
    variables: [
      ...
      { label: "External ID", value: "{{user.external_id}}", description: "User's external identifier" },
  ...
  },
  {
    ...
    variables: [
      { label: "Unsubscribe URL", value: "{{unsubscribe_url}}", description: "Link to unsubscribe" },
      { label: "Preferences URL", value: "{{preferences_url}}", description: "Link to email preferences" },
      { label: "Web Version URL", value: "{{web_version_url}}", description: "View in browser link" },
    ],
  },
  {
    label: "Campaign",
    ...
    variables: [
      { label: "Campaign Name", value: "{{campaign.name}}", description: "Name of the campaign" },
...
export function HtmlEditorHeader({
  editorRef,
