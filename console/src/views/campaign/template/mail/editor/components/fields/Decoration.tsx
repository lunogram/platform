...
> = {
  ...
  borderTopLeftRadius: (value, prefix) =>
    `${prefix}rounded-tl-${addUnit(value)}`,
  borderTopRightRadius: (value, prefix) =>
    `${prefix}rounded-tr-${addUnit(value)}`,
  borderBottomLeftRadius: (value, prefix) =>
    `${prefix}rounded-bl-${addUnit(value)}`,
  borderBottomRightRadius: (value, prefix) =>
    `${prefix}rounded-br-${addUnit(value)}`,
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleBorderWidthChange("borderTopWidth", e.target.value)
                    }
                    placeholder="0"
                    className="h-8 text-sm pl-7"
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleBorderWidthChange("borderLeftWidth", e.target.value)
                    }
                    placeholder="0"
                    className="h-8 text-sm pl-7"
