  ...
  return (
    <>
      ...
      <div className="flex items-center">
        ...
        />
        <span className="h-8 inline-flex items-center px-2 text-xs text-muted-foreground border border-l-0 bg-muted/50 rounded-r-md">{"times"}</span>
      </div>
      {frequency.period.type === "rolling" && (
        <div className="flex items-center">
          <span className="h-8 inline-flex items-center px-2 text-xs text-muted-foreground border bg-muted/50 rounded-l-md">{"in last"}</span>
          <Input
            type="text"
            placeholder="Value"
            className="h-8 w-16 rounded-none border-l-0 text-xs"
