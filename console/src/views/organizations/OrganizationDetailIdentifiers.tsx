...
export default function OrganizationDetailIdentifiers() {
    ...
    const refreshOrganization = async () => {
        const updatedOrganization = await oapiClient.GET(
        ...
        try {
            const response = await oapiClient.POST(
                "/api/admin/projects/{projectID}/subjects/organizations",
                {
                    ...
                    body: {
                        identifier: [
                            // Include existing identifiers so we target the right organization
                            ...identifiers.map((id) => ({
                                source: id.source,
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-0.5">
                        {t(
                            ...
                            "External identifiers used to identify this organization across systems",
                        )}
                    </p>
                </div>
                <Button
                    ...
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {t(
                                ...
                                "Add a new external identifier to this organization.",
                            )}
                        </DialogDescription>
                    </DialogHeader>
