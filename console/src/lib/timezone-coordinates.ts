...
const timezoneCoordinates: Record<string, [number, number]> = {
    ...
    'America/Montevideo': [-56.16, -34.90],
    'America/Montreal': [-73.57, 45.50],
    ...
    'America/Santo_Domingo': [-69.90, 18.47],
    ...
    'Pacific/Pago_Pago': [-170.70, -14.28],
    'Pacific/Port_Moresby': [147.15, -9.44],
    'Pacific/Tongatapu': [-175.20, -21.21],
