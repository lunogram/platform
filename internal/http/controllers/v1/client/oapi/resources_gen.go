...
type InboxMessage struct {
	...
	BroadcastId *openapi_types.UUID `json:"broadcast_id"`
...
func NewCreateSessionRequestWithBody(server string, projectID ProjectID, authMethodID openapi_types.UUID, contentType string, body io.Reader) (*http.Request, error) {
	...
	pathParam1, err = runtime.StyleParamWithLocation("simple", false, "authMethodID", runtime.ParamLocationPath, authMethodID)
	if err != nil {
		return nil, err
	}
...
func NewGetOrganizationInboxRequest(server string, projectID ProjectID, params *GetOrganizationInboxParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.MessageSource != nil {
			...
			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "message_source", runtime.ParamLocationQuery, *params.MessageSource); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
func (siw *ServerInterfaceWrapper) CreateSession(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "authMethodID", chi.URLParam(r, "authMethodID"), &authMethodID, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetOrganizationInbox(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameter("form", true, false, "message_source", r.URL.Query(), &params.MessageSource)
	if err != nil {
	...
	if paramValue := r.URL.Query().Get("channel"); paramValue != "" {
	...
	err = runtime.BindQueryParameter("form", true, true, "channel", r.URL.Query(), &params.Channel)
	if err != nil {
