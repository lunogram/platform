...
const (
	Completed JourneyUserStepType = "completed"
	Exited    JourneyUserStepType = "exited"
	Skipped   JourneyUserStepType = "skipped"
	Waiting   JourneyUserStepType = "waiting"
)
...
// JourneyUserEntrance defines model for JourneyUserEntrance.
type JourneyUserEntrance struct {
	CreatedAt  time.Time          `json:"created_at"`
...
// JourneyUserEntranceListResponse defines model for JourneyUserEntranceListResponse.
type JourneyUserEntranceListResponse struct {
	// Limit Maximum number of items returned
	Limit int `json:"limit"`

	// Offset Number of items skipped
	Offset  int                   `json:"offset"`
	Results []JourneyUserEntrance `json:"results"`

	// Total Total number of items matching the filters
	Total int `json:"total"`
}

// JourneyUserStep defines model for JourneyUserStep.
type JourneyUserStep struct {
	...
	Id         openapi_types.UUID `json:"id"`
	Journey    *Journey           `json:"journey,omitempty"`
	Step       *JourneyStep       `json:"step,omitempty"`

	// Type Status/type of the user step
	Type      JourneyUserStepType `json:"type"`
	UpdatedAt time.Time           `json:"updated_at"`
	User      *User               `json:"user,omitempty"`
}

// JourneyUserStepType Status/type of the user step
type JourneyUserStepType string
...
// JourneyUserStepListResponse defines model for JourneyUserStepListResponse.
type JourneyUserStepListResponse struct {
	// Limit Maximum number of items returned
	Limit int `json:"limit"`

	// Offset Number of items skipped
	Offset  int               `json:"offset"`
	Results []JourneyUserStep `json:"results"`
...
type ListJourneyEntrancesParams struct {
	// Limit Maximum number of items to return
	Limit *Limit `form:"limit,omitempty" json:"limit,omitempty"`
...
// ListJourneyStepUsersParams defines parameters for ListJourneyStepUsers.
type ListJourneyStepUsersParams struct {
	// Limit Maximum number of items to return
	Limit *Limit `form:"limit,omitempty" json:"limit,omitempty"`
...
type ClientInterface interface {
	...
	// ListJourneyEntrances request
	ListJourneyEntrances(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, params *ListJourneyEntrancesParams, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// ListJourneyStepUsers request
	ListJourneyStepUsers(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, params *ListJourneyStepUsersParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// RemoveUserFromJourneyStep request
	RemoveUserFromJourneyStep(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID, reqEditors ...RequestEditorFn) (*http.Response, error)

	// SkipJourneyStepDelay request
	SkipJourneyStepDelay(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID, reqEditors ...RequestEditorFn) (*http.Response, error)

	// TriggerUserToJourneyStep request
	TriggerUserToJourneyStep(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// RecountList request
	RecountList(ctx context.Context, projectID openapi_types.UUID, listID openapi_types.UUID, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) ListJourneyEntrances(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, params *ListJourneyEntrancesParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewListJourneyEntrancesRequest(c.Server, projectID, journeyID, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) ListJourneyStepUsers(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, params *ListJourneyStepUsersParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewListJourneyStepUsersRequest(c.Server, projectID, journeyID, stepID, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) RemoveUserFromJourneyStep(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewRemoveUserFromJourneyStepRequest(c.Server, projectID, journeyID, stepID, userID)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) SkipJourneyStepDelay(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewSkipJourneyStepDelayRequest(c.Server, projectID, journeyID, stepID, userID)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) TriggerUserToJourneyStep(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewTriggerUserToJourneyStepRequest(c.Server, projectID, journeyID, stepID, userID)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) RecountList(ctx context.Context, projectID openapi_types.UUID, listID openapi_types.UUID, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewRecountListRequest(c.Server, projectID, listID)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewListJourneyEntrancesRequest generates requests for ListJourneyEntrances
func NewListJourneyEntrancesRequest(server string, projectID openapi_types.UUID, journeyID openapi_types.UUID, params *ListJourneyEntrancesParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/admin/projects/%s/journeys/%s/entrances", pathParam0, pathParam1)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewListJourneyStepUsersRequest generates requests for ListJourneyStepUsers
func NewListJourneyStepUsersRequest(server string, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, params *ListJourneyStepUsersParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/admin/projects/%s/journeys/%s/steps/%s/users", pathParam0, pathParam1, pathParam2)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewRemoveUserFromJourneyStepRequest generates requests for RemoveUserFromJourneyStep
func NewRemoveUserFromJourneyStepRequest(server string, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/admin/projects/%s/journeys/%s/steps/%s/users/%s", pathParam0, pathParam1, pathParam2, pathParam3)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewSkipJourneyStepDelayRequest generates requests for SkipJourneyStepDelay
func NewSkipJourneyStepDelayRequest(server string, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/admin/projects/%s/journeys/%s/steps/%s/users/%s/skip", pathParam0, pathParam1, pathParam2, pathParam3)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewTriggerUserToJourneyStepRequest generates requests for TriggerUserToJourneyStep
func NewTriggerUserToJourneyStepRequest(server string, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/admin/projects/%s/journeys/%s/steps/%s/users/%s/trigger", pathParam0, pathParam1, pathParam2, pathParam3)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewRemoveUserFromJourneyRequest generates requests for RemoveUserFromJourney
func NewRemoveUserFromJourneyRequest(server string, projectID openapi_types.UUID, journeyID openapi_types.UUID, userID openapi_types.UUID) (*http.Request, error) {
	var err error
...
// NewRecountListRequest generates requests for RecountList
func NewRecountListRequest(server string, projectID openapi_types.UUID, listID openapi_types.UUID) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/admin/projects/%s/lists/%s/recount", pathParam0, pathParam1)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// ListJourneyEntrancesWithResponse request
	ListJourneyEntrancesWithResponse(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, params *ListJourneyEntrancesParams, reqEditors ...RequestEditorFn) (*ListJourneyEntrancesResponse, error)
	...
	// ListJourneyStepUsersWithResponse request
	ListJourneyStepUsersWithResponse(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, params *ListJourneyStepUsersParams, reqEditors ...RequestEditorFn) (*ListJourneyStepUsersResponse, error)

	// RemoveUserFromJourneyStepWithResponse request
	RemoveUserFromJourneyStepWithResponse(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID, reqEditors ...RequestEditorFn) (*RemoveUserFromJourneyStepResponse, error)

	// SkipJourneyStepDelayWithResponse request
	SkipJourneyStepDelayWithResponse(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID, reqEditors ...RequestEditorFn) (*SkipJourneyStepDelayResponse, error)

	// TriggerUserToJourneyStepWithResponse request
	TriggerUserToJourneyStepWithResponse(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID, reqEditors ...RequestEditorFn) (*TriggerUserToJourneyStepResponse, error)
	...
	// RecountListWithResponse request
	RecountListWithResponse(ctx context.Context, projectID openapi_types.UUID, listID openapi_types.UUID, reqEditors ...RequestEditorFn) (*RecountListResponse, error)
...
type ListJourneyEntrancesResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *JourneyUserEntranceListResponse
	JSONDefault  *Error
}

// Status returns HTTPResponse.Status
func (r ListJourneyEntrancesResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r ListJourneyEntrancesResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type ListJourneyStepUsersResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *JourneyUserStepListResponse
	JSONDefault  *Error
}

// Status returns HTTPResponse.Status
func (r ListJourneyStepUsersResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r ListJourneyStepUsersResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type RemoveUserFromJourneyStepResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSONDefault  *Error
}
...
// Status returns HTTPResponse.Status
func (r RemoveUserFromJourneyStepResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r RemoveUserFromJourneyStepResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type SkipJourneyStepDelayResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSONDefault  *Error
}
...
// Status returns HTTPResponse.Status
func (r SkipJourneyStepDelayResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r SkipJourneyStepDelayResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type TriggerUserToJourneyStepResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON201      *JourneyUserStep
	JSONDefault  *Error
}

// Status returns HTTPResponse.Status
func (r TriggerUserToJourneyStepResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r TriggerUserToJourneyStepResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type RemoveUserFromJourneyResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSONDefault  *Error
}
...
// Status returns HTTPResponse.Status
func (r RemoveUserFromJourneyResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r RemoveUserFromJourneyResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type RecountListResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON202      *List
	JSONDefault  *Error
...
// Status returns HTTPResponse.Status
func (r RecountListResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r RecountListResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
func (c *ClientWithResponses) ListJourneyEntrancesWithResponse(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, params *ListJourneyEntrancesParams, reqEditors ...RequestEditorFn) (*ListJourneyEntrancesResponse, error) {
	rsp, err := c.ListJourneyEntrances(ctx, projectID, journeyID, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseListJourneyEntrancesResponse(rsp)
}
...
// ListJourneyStepUsersWithResponse request returning *ListJourneyStepUsersResponse
func (c *ClientWithResponses) ListJourneyStepUsersWithResponse(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, params *ListJourneyStepUsersParams, reqEditors ...RequestEditorFn) (*ListJourneyStepUsersResponse, error) {
	rsp, err := c.ListJourneyStepUsers(ctx, projectID, journeyID, stepID, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseListJourneyStepUsersResponse(rsp)
}

// RemoveUserFromJourneyStepWithResponse request returning *RemoveUserFromJourneyStepResponse
func (c *ClientWithResponses) RemoveUserFromJourneyStepWithResponse(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID, reqEditors ...RequestEditorFn) (*RemoveUserFromJourneyStepResponse, error) {
	rsp, err := c.RemoveUserFromJourneyStep(ctx, projectID, journeyID, stepID, userID, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseRemoveUserFromJourneyStepResponse(rsp)
}

// SkipJourneyStepDelayWithResponse request returning *SkipJourneyStepDelayResponse
func (c *ClientWithResponses) SkipJourneyStepDelayWithResponse(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID, reqEditors ...RequestEditorFn) (*SkipJourneyStepDelayResponse, error) {
	rsp, err := c.SkipJourneyStepDelay(ctx, projectID, journeyID, stepID, userID, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseSkipJourneyStepDelayResponse(rsp)
}

// TriggerUserToJourneyStepWithResponse request returning *TriggerUserToJourneyStepResponse
func (c *ClientWithResponses) TriggerUserToJourneyStepWithResponse(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID, reqEditors ...RequestEditorFn) (*TriggerUserToJourneyStepResponse, error) {
	rsp, err := c.TriggerUserToJourneyStep(ctx, projectID, journeyID, stepID, userID, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseTriggerUserToJourneyStepResponse(rsp)
}

// RemoveUserFromJourneyWithResponse request returning *RemoveUserFromJourneyResponse
func (c *ClientWithResponses) RemoveUserFromJourneyWithResponse(ctx context.Context, projectID openapi_types.UUID, journeyID openapi_types.UUID, userID openapi_types.UUID, reqEditors ...RequestEditorFn) (*RemoveUserFromJourneyResponse, error) {
	rsp, err := c.RemoveUserFromJourney(ctx, projectID, journeyID, userID, reqEditors...)
	if err != nil {
		return nil, err
	}
...
// RecountListWithResponse request returning *RecountListResponse
func (c *ClientWithResponses) RecountListWithResponse(ctx context.Context, projectID openapi_types.UUID, listID openapi_types.UUID, reqEditors ...RequestEditorFn) (*RecountListResponse, error) {
	rsp, err := c.RecountList(ctx, projectID, listID, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseRecountListResponse(rsp)
}
...
// ParseListJourneyEntrancesResponse parses an HTTP response from a ListJourneyEntrancesWithResponse call
func ParseListJourneyEntrancesResponse(rsp *http.Response) (*ListJourneyEntrancesResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &ListJourneyEntrancesResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest JourneyUserEntranceListResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
// ParseListJourneyStepUsersResponse parses an HTTP response from a ListJourneyStepUsersWithResponse call
func ParseListJourneyStepUsersResponse(rsp *http.Response) (*ListJourneyStepUsersResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &ListJourneyStepUsersResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest JourneyUserStepListResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
// ParseRemoveUserFromJourneyStepResponse parses an HTTP response from a RemoveUserFromJourneyStepWithResponse call
func ParseRemoveUserFromJourneyStepResponse(rsp *http.Response) (*RemoveUserFromJourneyStepResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &RemoveUserFromJourneyStepResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseSkipJourneyStepDelayResponse parses an HTTP response from a SkipJourneyStepDelayWithResponse call
func ParseSkipJourneyStepDelayResponse(rsp *http.Response) (*SkipJourneyStepDelayResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &SkipJourneyStepDelayResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseTriggerUserToJourneyStepResponse parses an HTTP response from a TriggerUserToJourneyStepWithResponse call
func ParseTriggerUserToJourneyStepResponse(rsp *http.Response) (*TriggerUserToJourneyStepResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &TriggerUserToJourneyStepResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseRemoveUserFromJourneyResponse parses an HTTP response from a RemoveUserFromJourneyWithResponse call
func ParseRemoveUserFromJourneyResponse(rsp *http.Response) (*RemoveUserFromJourneyResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &RemoveUserFromJourneyResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseRecountListResponse parses an HTTP response from a RecountListWithResponse call
func ParseRecountListResponse(rsp *http.Response) (*RecountListResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
...
type ServerInterface interface {
	...
	// (GET /api/admin/projects/{projectID}/journeys/{journeyID}/entrances)
	ListJourneyEntrances(w http.ResponseWriter, r *http.Request, projectID openapi_types.UUID, journeyID openapi_types.UUID, params ListJourneyEntrancesParams)
	// Publish journey
	...
	// (GET /api/admin/projects/{projectID}/journeys/{journeyID}/steps/{stepID}/users)
	ListJourneyStepUsers(w http.ResponseWriter, r *http.Request, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, params ListJourneyStepUsersParams)
	// Remove user from journey step
	// (DELETE /api/admin/projects/{projectID}/journeys/{journeyID}/steps/{stepID}/users/{userID})
	RemoveUserFromJourneyStep(w http.ResponseWriter, r *http.Request, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID)
	// Skip delay for user
	// (POST /api/admin/projects/{projectID}/journeys/{journeyID}/steps/{stepID}/users/{userID}/skip)
	SkipJourneyStepDelay(w http.ResponseWriter, r *http.Request, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID)
	// Trigger user into journey entrance
	// (POST /api/admin/projects/{projectID}/journeys/{journeyID}/steps/{stepID}/users/{userID}/trigger)
	TriggerUserToJourneyStep(w http.ResponseWriter, r *http.Request, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID)
	...
	// Recount list users
	// (POST /api/admin/projects/{projectID}/lists/{listID}/recount)
	RecountList(w http.ResponseWriter, r *http.Request, projectID openapi_types.UUID, listID openapi_types.UUID)
	// Get list users
...
// List journey entrances
// (GET /api/admin/projects/{projectID}/journeys/{journeyID}/entrances)
func (_ Unimplemented) ListJourneyEntrances(w http.ResponseWriter, r *http.Request, projectID openapi_types.UUID, journeyID openapi_types.UUID, params ListJourneyEntrancesParams) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// List users in journey step
// (GET /api/admin/projects/{projectID}/journeys/{journeyID}/steps/{stepID}/users)
func (_ Unimplemented) ListJourneyStepUsers(w http.ResponseWriter, r *http.Request, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, params ListJourneyStepUsersParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Remove user from journey step
// (DELETE /api/admin/projects/{projectID}/journeys/{journeyID}/steps/{stepID}/users/{userID})
func (_ Unimplemented) RemoveUserFromJourneyStep(w http.ResponseWriter, r *http.Request, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Skip delay for user
// (POST /api/admin/projects/{projectID}/journeys/{journeyID}/steps/{stepID}/users/{userID}/skip)
func (_ Unimplemented) SkipJourneyStepDelay(w http.ResponseWriter, r *http.Request, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Trigger user into journey entrance
// (POST /api/admin/projects/{projectID}/journeys/{journeyID}/steps/{stepID}/users/{userID}/trigger)
func (_ Unimplemented) TriggerUserToJourneyStep(w http.ResponseWriter, r *http.Request, projectID openapi_types.UUID, journeyID openapi_types.UUID, stepID string, userID openapi_types.UUID) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// Recount list users
// (POST /api/admin/projects/{projectID}/lists/{listID}/recount)
func (_ Unimplemented) RecountList(w http.ResponseWriter, r *http.Request, projectID openapi_types.UUID, listID openapi_types.UUID) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// ListJourneyEntrances operation middleware
func (siw *ServerInterfaceWrapper) ListJourneyEntrances(w http.ResponseWriter, r *http.Request) {
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params ListJourneyEntrancesParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ListJourneyEntrances(w, r, projectID, journeyID, params)
	}))
...
// ListJourneyStepUsers operation middleware
func (siw *ServerInterfaceWrapper) ListJourneyStepUsers(w http.ResponseWriter, r *http.Request) {
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params ListJourneyStepUsersParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ListJourneyStepUsers(w, r, projectID, journeyID, stepID, params)
	}))
...
// RemoveUserFromJourneyStep operation middleware
func (siw *ServerInterfaceWrapper) RemoveUserFromJourneyStep(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.RemoveUserFromJourneyStep(w, r, projectID, journeyID, stepID, userID)
	}))
...
// SkipJourneyStepDelay operation middleware
func (siw *ServerInterfaceWrapper) SkipJourneyStepDelay(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.SkipJourneyStepDelay(w, r, projectID, journeyID, stepID, userID)
	}))
...
// TriggerUserToJourneyStep operation middleware
func (siw *ServerInterfaceWrapper) TriggerUserToJourneyStep(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.TriggerUserToJourneyStep(w, r, projectID, journeyID, stepID, userID)
	}))
...
// RemoveUserFromJourney operation middleware
func (siw *ServerInterfaceWrapper) RemoveUserFromJourney(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.RemoveUserFromJourney(w, r, projectID, journeyID, userID)
	}))
...
// RecountList operation middleware
func (siw *ServerInterfaceWrapper) RecountList(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.RecountList(w, r, projectID, listID)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/api/admin/projects/{projectID}/journeys/{journeyID}/entrances", wrapper.ListJourneyEntrances)
	})
	r.Group(func(r chi.Router) {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/api/admin/projects/{projectID}/journeys/{journeyID}/steps/{stepID}/users", wrapper.ListJourneyStepUsers)
	})
	r.Group(func(r chi.Router) {
		r.Delete(options.BaseURL+"/api/admin/projects/{projectID}/journeys/{journeyID}/steps/{stepID}/users/{userID}", wrapper.RemoveUserFromJourneyStep)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/api/admin/projects/{projectID}/journeys/{journeyID}/steps/{stepID}/users/{userID}/skip", wrapper.SkipJourneyStepDelay)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/api/admin/projects/{projectID}/journeys/{journeyID}/steps/{stepID}/users/{userID}/trigger", wrapper.TriggerUserToJourneyStep)
	})
	r.Group(func(r chi.Router) {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/api/admin/projects/{projectID}/lists/{listID}/recount", wrapper.RecountList)
	})
	r.Group(func(r chi.Router) {
