...
```
PUT /api/client/users/scheduled
```

| Field          | Type     | Required | Description                                                |
| -------------- | -------- | -------- | ---------------------------------------------------------- |
| `name`         | string   | Yes      | Schedule name (must match an existing schedule definition) |
| `external_id`  | string   | \*       | User's external ID                                         |
| `anonymous_id` | string   | \*       | User's anonymous ID                                        |
...
\* At least one of `external_id` or `anonymous_id` is required.
\*\* Provide `scheduled_at` for single schedules or `interval` for recurring schedules.

### Organization Schedules

```
PUT /api/client/organizations/scheduled
```

| Field                      | Type     | Required | Description                                          |
| -------------------------- | -------- | -------- | ---------------------------------------------------- |
| `name`                     | string   | Yes      | Schedule name                                        |
| `organization_external_id` | string   | Yes      | Organization's external ID                           |
| `scheduled_at`             | datetime | \*\*     | Fire time for single schedules                       |
...
{
  "name": "trial_expiration",
  "organization_external_id": "org_456"
}
```
