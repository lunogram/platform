...
## Overview
Campaigns are how all messaging happens within Lunogram. Whether that be sending an email blast or calling a webhook inside of a journey, all of that uses a campaign.
...
<Cards>
    <Card title="Create" href="/how-to/campaigns/create">Start here to get up and running and get aquainted at a high level with sending messages with Lunogram.</Card>
