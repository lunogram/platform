...
## Inbound
Email sending is not the only important part, you also need to keep track of things like email opens, clicks, unsubscribes, bounces and complaints. Lunogram automatically takes care of opens, clicks and unsubscribes for you, but bounces and complaints require webhooks from SendGrid.
...
3. Enter the Lunogram SendGrid unsubscribe URL for your provider (which can be found on the provider details screen)
