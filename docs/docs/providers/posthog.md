# PostHog
Lunogram supports sending events to PostHog. Follow the instructions below to setup.
...
4. Navigate to the Lunogram integrations page, hit `Add Integration` and select the `PostHog` integration.
